...
public class EmailSearcher {
     ...
     * @return 
     */
    public Message[] searchEmail(String host, String port, String userName,
            String password, final String keyword, final String field) {
                    ...
                    try {
                        switch (field) {
                            ...
                            case "messageNumber":
                                ...
                                if(messageNumberInteger.toString().equals(keyword)){
